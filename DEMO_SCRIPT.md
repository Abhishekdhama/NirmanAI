...
**Record from `localhost`, not from the live Streamlit Cloud URL.** The hosted app
sleeps after inactivity and shows a "Zzzz — this app has gone to sleep" screen,
which takes up to a minute to wake. Fine for a submission link, fatal on camera.
